...
export default class ProductPostConfig extends SourceConfig {
  ...
  getDescription() {
    return "This is a description of the sample product.";
  }

  getLink() {
    return "https://example.com/product/sample-product";
  }
}
