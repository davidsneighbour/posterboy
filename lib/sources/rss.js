...
export default class BlogPostConfig extends SourceConfig {

  slug = "rss";

  getTitle() {
    return "Sample Blog Post Title";
  }

  getDescription() {
    return "This is a description of the sample blog post.";
  }

  getLink() {
    return "https://example.com/blog/sample-post";
  }
}
